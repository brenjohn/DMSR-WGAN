...
All the following commands should be run from the example directory.
...
```
python ../scripts/dataset_preparation.py --config_file=dataset_config_train.toml --num_procs=4
```
...
```
python ../scripts/dmsr_train.py --parameter_file=training_parameters.toml
```
